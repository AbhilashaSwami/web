...
let socket = io(`http://localhost:9080`);
...
componentDidMount() {
  ...
  render() {
   ...
   <TextField
    ...
    <div style={{color: '#006064',marginLeft: 20, float:'right', paddingTop:40, width: '30%'}} >
    ...
    <div style={{color: '#006064',marginLeft: 70, float:'right', paddingTop:40, width: '30%'}} >
    ...
    <div style={{color: '#006064',marginLeft: 100, float:'right', paddingTop:40, width: '30%'}} >
